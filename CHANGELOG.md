...
- **Optional Local Brain (`@centr/brain`)**:
...
- **Real-Agent A/B Benchmark Harness (`@centr/benchmark-ab`)**:
  ...
  - 21 verified real-agent runs on Google Antigravity (Gemini 2.5 Pro) with 100% test success and -33% exploratory tool calls.
